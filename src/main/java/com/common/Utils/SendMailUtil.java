...
public class SendMailUtil {
    // 发件人邮箱地址
    private static String from = "1648577019@qq.com";
    // 发件人称号，同邮箱地址
    private static String user = "1648577019@qq.com";
    // 发件人邮箱客户端授权码
    private static String password = "bdaojtpurvheejad";
    //发件人的邮箱服务器
