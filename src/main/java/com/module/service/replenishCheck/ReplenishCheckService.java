package com.module.service.replenishCheck;
...
import com.module.dao.replenishCheck.ReplenishCheckDao;
import com.module.entity.replenishCheck.ReplenishCheck;
import com.module.request.replenishCheck.ReplenishCheckRequest;
import com.module.response.replenishCheck.ReplenishCheckCode;
import com.module.response.replenishCheck.ReplenishCheckResult;
...
public class ReplenishCheckService {
    ...
    public ReplenishCheckResult add(ReplenishCheck replenishCheck) {
        ...
        //返回失败
        return new ReplenishCheckResult(ReplenishCheckCode.CMS_NAME_REPETITION, null);
    }
