...
public class WarnInWeightService {
    ...
    public WarnInWeightResult add(WarnInWeight warnInWeight) {
            ...
            one.setTrashCollectId(warnInWeight.getTrashCollectId());
            one.setStatus(warnInWeight.getStatus());
