package com.module.service.warn.warnLeakage;
...
import com.module.request.warn.warnLeakage.WarnLeakageRequest;
import com.module.response.warn.warnLeakage.WarnLeakageCode;
import com.module.response.warn.warnLeakage.WarnLeakageResult;
...
public class WarnLeakageService {
    ...
    public WarnLeakageResult add(WarnLeakage warnLeakage) {
            ...
            one.setDepartmentId(warnLeakage.getDepartmentId());
            one.setOfficeId(warnLeakage.getOfficeId());
            one.setLevel(warnLeakage.getLevel());
            one.setStatus(warnLeakage.getStatus());
            one.setCode(warnLeakage.getCode());
            one.setCollectId(warnLeakage.getCollectId());
            one.setCollectNumber(warnLeakage.getCollectNumber());
            one.setTrashId(warnLeakage.getTrashId());
            one.setWeight(warnLeakage.getWeight());
            one.setWarnTime(warnLeakage.getWarnTime());
            one.setCollectTime(warnLeakage.getCollectTime());
            one.setPutInTime(warnLeakage.getPutInTime());
