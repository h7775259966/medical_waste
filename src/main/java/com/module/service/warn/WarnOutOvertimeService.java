...
public class WarnOutOvertimeService {
    ...
    public WarnOutOvertimeResult add(WarnOutOvertime warnOutOvertime) {
            ...
            one.setTrashCollectId(warnOutOvertime.getTrashCollectId());
